...
export const getSingleProductController=async(req,res)=>{
    ...
    res.status(200).send({
        success:true,
        message:"successfully got that product",
        product
    })
...
export const updateProductController=async(req,res)=>{
    ...
    if(photo){
        ...
        res.status(500).send({
            success:false,
            message:"Error in updation of the product",
            error
        })
    }
}
...
//similar products
export const relatedProductCntroller=async(req,res)=>{
    try {
        ...
        res.status(400).send({
            success:false,
            message:"Error in getting similar results b"
        ,error
        })
    }
}
...
export const productCategoryController=async(req,res)=>{
    try {
      ...
      res.status(200).send({
        ...
        res.status(400).send({
            success:false,
            message:"Error in getting category related products",
            error
        })
    }
}
...
//this gateway is defined in the beginning of this file------
...
export const braintreeTokenController=async(req,res)=>{
    try {
        ...
        console.log("Erron b: "+error);
    }
}

//payment (read documen)
